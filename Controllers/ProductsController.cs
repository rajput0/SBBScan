...
using SBBScan.Data;
using SBBScan.Models;

namespace SBBScan.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Barcode,Name,Description,Price,TotalSoldToday")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
